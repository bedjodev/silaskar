...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="template/moltran/images/favicon_1.ico">
        ...
        <!-- sweet alerts -->
        <link href="../template/moltran/assets/sweet-alert/sweet-alert.min.css" rel="stylesheet">
        ...
        <script src="../template/moltran/template/moltran/js/modernizr.min.js"></script>
    ...
    <body class="fixed-left">
                                        ...
                                        <div class="inbox-widget nicescroll mx-box">
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-1.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-2.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-3.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-4.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-5.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-6.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-8.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img"><img src="../template/moltran/images/users/avatar-9.jpg" class="img-circle" alt=""></div>
                                            ...
                                            <ul class="conversation-list nicescroll">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="../template/moltran/images/avatar-1.jpg" alt="male">
                                                        <i>10:00</i>
                                                    </div>
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="../template/moltran/images/users/avatar-5.jpg" alt="Female">
                                                        <i>10:01</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="../template/moltran/images/users/avatar-5.jpg" alt="male">
                                                        <i>10:02</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
        ...
        <script src="../template/moltran/assets/chat/moment-2.2.1.js"></script>
        <script src="../template/moltran/assets/jquery-sparkline/jquery.sparkline.min.js"></script>
        ...
        <!-- sweet alerts -->
        <script src="../template/moltran/assets/sweet-alert/sweet-alert.min.js"></script>
        <script src="../template/moltran/assets/sweet-alert/sweet-alert.init.js"></script>

        <!-- flot Chart -->
        <script src="../template/moltran/assets/flot-chart/jquery.flot.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.time.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.tooltip.min.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.resize.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.pie.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.selection.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.stack.js"></script>
        <script src="../template/moltran/assets/flot-chart/jquery.flot.crosshair.js"></script>

        <!-- Counter-up -->
        <script src="../template/moltran/assets/counterup/waypoints.min.js" type="text/javascript"></script>
        <script src="../template/moltran/assets/counterup/jquery.counterup.min.js" type="text/javascript"></script>
        
        <!-- CUSTOM JS -->
        <script src="../template/moltran/js/jquery.app.js"></script>

        <!-- Dashboard -->
        <script src="../template/moltran/js/jquery.dashboard.js"></script>

        <!-- Chat -->
        <script src="../template/moltran/js/jquery.chat.js"></script>

        <!-- Todo -->
        <script src="../template/moltran/js/jquery.todo.js"></script>
