						...
						<div class="row">
							<div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Form Ubah Petugas</h3></div>
                                    <div class="panel-body">
									<?php foreach ($petugas as $p){?>
                                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('dashboard_petugas/ubah_petugas_aksi');?>">
                                            <input type="hidden" class="form-control" name="id_user" value="<?php echo $p->id_user?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" class="form-control" name="kontak" value="<?php echo $p->kontak?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <select class="form-control" name="level">
													<option value="1" <?php if(($p->level)=='1'){echo 'selected';} ?>>Admin</option>
													<option value="2" <?php if(($p->level)=='2'){echo 'selected';} ?>>Petugas</option>
												  </select>
                                                </div>
                                            </div>
